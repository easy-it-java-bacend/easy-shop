...
public class OrderController {
    ...
    public ResponseEntity<?> getAllOrdesLessThan(@RequestParam(defaultValue = "0") Double limit) {
        return orderService.getOrdersLessThan(limit);
    }

    @GetMapping("/get-all-between")
    public ResponseEntity<?> getAllOrdesBetween(@RequestParam Double floor, @RequestParam Double ceil) {
